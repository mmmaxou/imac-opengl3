...
int main(int argc, char** argv) {
  ...
  while(!done) {
    ...
    glm::vec4 earthLightDir4 = glm::vec4(1.0f, 1.0f, 1.0f, 0.0f) * globalVMatrix;
    glm::vec3 earthLightDir3 = glm::vec3(earthLightDir4.x, earthLightDir4.y, earthLightDir4.z);
    ...
    // uLightDir_vs
    glUniform3fv(earthProgram.uLightDir_vs, 1, glm::value_ptr(earthLightDir3));
    // uLightIntensity
    float earthLi = 5.f;
    ...
    for ( int i=0; i<32; i++) {   
      ...
      // Light Direction
      glm::vec4 lDir4 = glm::vec4(1.0f, 1.0f, 1.0f, 0.0f) * globalVMatrix;
      glm::vec3 lDir = glm::vec3(lDir4.x, lDir4.y, lDir4.z);
